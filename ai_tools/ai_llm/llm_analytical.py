...
class AnalyticalLLM:
    ...
    async def _handle_query(self, user_input, chat_history):
        """Handle the user's query with analytical approach."""
        input_message = [
    ...
    async def run(self):
        """Run the AnalyticalLLM and process user queries."""
        print("AnalyticalLLM: Ready to analyze your questions.")
        chat_history = []  # Store chat history for ongoing conversations

        while True:
            user_input = input("You: ")
            if user_input.lower() == "exit":
                print("AnalyticalLLM: Goodbye!")
                break
            ...
            print(f"AnalyticalLLM: {result}")


# Example usage: Running the AnalyticalLLM
